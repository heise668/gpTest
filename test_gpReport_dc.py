...
def get_data(url):
    ...
    for item in data:
        ...
        TOTALOPERATEREVE=round(TOTALOPERATEREVE/100000000,3)  #总营业额：亿元

        print (SECURITY_NAME_ABBR,REPORT_DATE_NAME,TOTALOPERATEREVE)

if __name__=="__main__":
    url = "http://emweb.securities.eastmoney.com/PC_HSF10/NewFinanceAnalysis/ZYZBAjaxNew?type=1&code=SZ000587"
    get_data(url)