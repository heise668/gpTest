...
if __name__=="__main__":
    ...
    group={'方正证券': '601901.SS','瑞丰光电':'300241.SZ','高新兴':'300098.SZ','供销大集': '000564.SZ',
           '海尔智家': '600690.SS','杭钢股份':'600126.SS'}
    group2={'好想你': '002582.SZ','上海物贸':'600822.SS','百联股份': '600827.SS','特锐德': '300001.SZ',
    ...
    group_bak={'旋极信息': '300324.SZ','广电运通': '002152.SZ','中光学':'002189.SZ','葛洲坝': '600068.SS',
               '奥马电器': '002668.SZ','南天信息': '000948.SZ','神州信息': '000555.SZ','世纪华通': '002602.SZ',
               '达安基因': '002030.SZ','明德生物': '002932.SZ','圣湘生物': '688289.SS','东方生物': '688298.SS',}
    ...
    for name,stock in groups.items():
       ...
       # stock_item.pop('成交量')
        ...
        if stock in group.values():
            if s_rise>0:
                print(f'\033[1;31m{stock_item} \033[0m')
            else:
                print(f'\033[31m{stock_item}\033[0m' )
        elif stock in group2.values():
            if s_rise > 0:

                print(f'\033[1;35m{stock_item}\033[0m')
            else:
                print(f'\033[35m{stock_item}\033[0m')

        else:
            if s_rise > 0:
                print(f'\033[1;37m{stock_item}\033[0m')
            else:
                print(f'\033[37m{stock_item}\033[0m')
            #print (stock_item)
